...
(function($){
	$.extend({
	jMessageBox : {
		settings : {width: 300, title : '', bottomText : '', yesButtonText : '', noButtonText : '', cancelButtonText : ''},
		_init : function(){
			...
			if(container.length == 0){
				...
				$('#jmessagebox_title').html($.jMessageBox.settings.title == '' ? "\u63d0\u793a" : $.jMessageBox.settings.title);
				$('#jmessagebox_yesbutton').html($.jMessageBox.settings.yesButtonText == '' ? "\u786e\u5b9a" : $.jMessageBox.settings.yesButtonText);
				$('#jmessagebox_nobutton').html($.jMessageBox.settings.noButtonText == '' ? "\u786e\u5b9a" : $.jMessageBox.settings.noButtonText);
				$('#jmessagebox_cancelbutton').html($.jMessageBox.settings.cancelButtonText == '' ? "\u53d6\u6d88" : $.jMessageBox.settings.cancelButtonText);
