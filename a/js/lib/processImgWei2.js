                ...
                if (wx) {
                    ...
                    wx.chooseImage({
                        ...
                        success: function (res) {
                            ...
                            //    p.src = srcString;
                            //}
                            //weixin://resourceid/77e626f2a707c751918ef3363d9b89bc
                            // p.src = srcString; 
                            ...
                            viewImg.onload = function () {
                                ...
                                // document.domain = viewImg.src;
                                hidCanvas.height = viewImg.height;
                                hidCanvas.width = viewImg.width;
                                hidCtx.drawImage(viewImg, 0, 0);
                                var dataURL = "";
                                try {
                                    dataURL = hidCanvas.toDataURL("image/jpeg", 0.5);
                                } catch (e) {
                                    alert(e);
                                }
	                        ...
	                        p.onload = function () {
	                            ...
	                            hidCanvas.height = upImgHeight;
	                            hidCanvas.width = upImgWidth;

	                           
	                            try {

	                                hidCtx.drawImage(p, 0, 0);
	                                console.log(hidCanvas.toDataURL());
	                                console.log(5);
	                            } catch (e) {
	                                console.log(e);
	                            } 
