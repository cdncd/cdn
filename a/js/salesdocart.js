...
function refreshMiniCart() {
    ...
    try {
        ...
        $.ajax({
            type: 'POST',
            url: '/ServiceAPI/sales/Cart.aspx',
            ...
            success: function (data) {
               ...
               // if (data.id == 1) {
                    ...
                    $('#cartmini_quantity').html(data.count);
                    $('#cartmini_total').html(data.total);
                //} 
            } 
        });
    ...
    try {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.id == 1) {
                    if (g) {
                        alertify.alert(data.messages, function (e) {
                            window.location.href = "/a/sales/cart.aspx";
                        });
                    } else {
                        alertify.success(data.messages, 1000);
                        refreshMiniCart();
                    }
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.id == 1) {
                        ...
                        alertify.alert(data.messages, function () {
                            window.location.href = "/a/sales/login.aspx";
                        }); 
